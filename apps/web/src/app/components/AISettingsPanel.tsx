      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {topics.map((topic, index) => (
            <span key={index} className="flex items-center bg-blue-500/20 text-blue-500 px-3 py-1 rounded-full text-sm font-medium">
              {topic}
              {!isReadOnly && (
                <button
                  type="button"
          ...
          <div className="flex gap-2 items-center min-w-0">
            ...
            {!isReadOnly && (
              <button
                ...
                className="hidden sm:inline-flex px-3 py-2 text-sm font-medium bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                + Add
              </button>
            )}
