    ...
    <div className="flex flex-col md:flex-row gap-0 h-full min-h-[60dvh] overflow-x-hidden">
      ...
      <div className="hidden md:flex xl:hidden flex-col md:w-80 min-h-[60dvh] max-w-full overflow-x-hidden">
        <div className="self-stretch">
          <div className="flex w-full bg-white/6 border-white/20 rounded-tr-lg p-1 gap-1">
            <button
              type="button"
        ...
        <div className="flex-1 min-h-0">
          {activePanel === 'players' ? (
            <div className="bg-white/6 backdrop-blur-xl rounded-br-lg p-6 h-full flex flex-col">
              <PlayerList 
                gameState={gameState}
            ...
            <div ref={chatContainerRef} className="bg-white/6 backdrop-blur-xl rounded-br-lg p-6 h-full flex flex-col">
              <Chat
      ...
      <div 
        ...
        className={`hidden xl:flex w-full xl:w-[clamp(16rem,20vw,20rem)] bg-white/6 backdrop-blur-xl rounded-r-lg p-6 xl:p-5 h-full min-h-[60dvh] flex-col max-w-full overflow-x-hidden flex-shrink-0`}
      >
        <Chat
          messages={chatMessages}
          currentPlayerId={currentPlayerId}
