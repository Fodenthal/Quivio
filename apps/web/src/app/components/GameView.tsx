...
export const GameView = memo(function GameView({ 
  ...
  return (
    <div className="flex flex-col md:flex-row gap-0 h-full min-h-[60dvh] overflow-x-hidden">
      ...
      <div className="relative flex-1 lg:min-w-[580px] bg-white/10 backdrop-blur-xl rounded-lg md:rounded-l-lg md:rounded-r-none shadow-glass p-8 space-y-6 h-full min-h-[60dvh] flex flex-col">
      ...
      <div 
        ...
        className={`hidden xl:flex w-full xl:w-[clamp(16rem,20vw,20rem)] bg-white/8 backdrop-blur-xl rounded-r-lg shadow-glass p-6 xl:p-5 h-full min-h-[60dvh] flex-col max-w-full overflow-x-hidden flex-shrink-0`}
      >
        <Chat
          messages={chatMessages}
          currentPlayerId={currentPlayerId}
