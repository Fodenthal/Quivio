...
export const metadata: Metadata = blogMetadata["improve-trivia-skills"];
      ...
      <footer className="border-t border-white/10 pt-8 mt-12">
        ...
        <section className="mt-6 bg-white/5 border border-white/10 rounded-lg p-6">
          ...
          <p className="text-sm text-gray-300">
            Written by <strong>Samira Khan</strong>, Learning Designer (M.Ed) at Quivio. Reviewed by <strong>Jordan Lee</strong>, Research Lead.
          </p>
